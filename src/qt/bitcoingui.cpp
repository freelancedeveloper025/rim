                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Rimecoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Rimecoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Rimecoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Rim"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Rim addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Rim addresses"));
    ...
    openAction->setStatusTip(tr("Open a Rim: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Rimecoin Core help message to get a list with possible Rim command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Rimecoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Rim network", "", count));
}
...
{
    QString strTitle = tr("Rimecoin Core"); // default title
