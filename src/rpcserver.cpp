...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Rim features */
        {"rim", "masternode", &masternode, true, true, false},
        {"rim", "listmasternodes", &listmasternodes, true, true, false},
        {"rim", "getmasternodecount", &getmasternodecount, true, true, false},
        {"rim", "masternodeconnect", &masternodeconnect, true, true, false},
        {"rim", "masternodecurrent", &masternodecurrent, true, true, false},
        {"rim", "masternodedebug", &masternodedebug, true, true, false},
        {"rim", "startmasternode", &startmasternode, true, true, false},
        {"rim", "createmasternodekey", &createmasternodekey, true, true, false},
        {"rim", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"rim", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"rim", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"rim", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"rim", "getmasternodescores", &getmasternodescores, true, true, false},
        {"rim", "mnbudget", &mnbudget, true, true, false},
        {"rim", "preparebudget", &preparebudget, true, true, false},
        {"rim", "submitbudget", &submitbudget, true, true, false},
        {"rim", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"rim", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"rim", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"rim", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"rim", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"rim", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"rim", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"rim", "checkbudgets", &checkbudgets, true, true, false},
        {"rim", "mnsync", &mnsync, true, true, false},
        {"rim", "spork", &spork, true, true, false},
        {"rim", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"rim", "privatesend", &privatesend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use rimd, or the -server option to rim-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Rim Alert\" admin@foo.com\n"),
...
{
    return "> rim-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:51394/\n";
}
