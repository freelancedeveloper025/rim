...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (1, uint256("0x00000174428e9427bc501b77fe65e24ba98a4c9e0313eca7db0de7be391e1a2e"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1539775705, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 51395;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Rim starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 2 * 60; // Rim: 1 day
        nTargetSpacing = 2 * 60;  // Rim: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 20;
        ...
        genesis.nNonce = 415827;

                       
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000efc55d94af490a5b3da6f8037268adae0eadcbd723a9c679588c032f46c"));
        assert(genesis.hashMerkleRoot == uint256("0x6e7d125c34de4900eebd6e50addb772ed22fb8191a778f8dca479e52db7a0447"));

        vSeeds.push_back(CDNSSeedData("46.101.39.208", "46.101.39.208")); 
        vSeeds.push_back(CDNSSeedData("46.101.46.232", "46.101.46.232")); 
		vSeeds.push_back(CDNSSeedData("46.101.40.210", "46.101.40.210"));
		vSeeds.push_back(CDNSSeedData("178.128.221.220", "178.128.221.220"));
		vSeeds.push_back(CDNSSeedData("142.93.254.239", "142.93.254.239"));
		vSeeds.push_back(CDNSSeedData("104.248.23.132", "104.248.23.132"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Rim: 1 day
        nTargetSpacing = 1 * 60;  // Rim: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
...
*/
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet rim addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet rim script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet rim BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet rim BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet rim BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Rim: 1 day
        nTargetSpacing = 1 * 60;        // Rim: 1 minutes
